...
and privacy policy. It is published with GitHub Pages at
`https://nduworker.github.io/oh-tidepool-site/`.
...
The `media/` directory publishes the app's reviewed, versioned WebP
